...
export const menuSchema: MenuItemSchema[] = [
  {
    ...
    submenu: [
      ...
      { id: 'open', label: 'Open...', accelerator: 'CmdOrCtrl+O', action: 'open-file' },
      { type: 'separator', id: 'sep-1' },
      { id: 'save', label: 'Save', accelerator: 'CmdOrCtrl+S', action: 'save-file', requires: ['hasFile'] },
      { id: 'save-as', label: 'Save As...', accelerator: 'CmdOrCtrl+Shift+S', action: 'save-file-as' },
      { type: 'separator', id: 'sep-close' },
      { id: 'close', label: 'Close', accelerator: 'CmdOrCtrl+W', action: 'close-file', requires: ['hasFile'] },
      { type: 'separator', id: 'sep-2' },
      { id: 'settings', label: 'Settings...', accelerator: 'CmdOrCtrl+,', action: 'open-settings' },
      { type: 'separator', id: 'sep-3', electronOnly: true },
      { id: 'quit', label: 'Quit', accelerator: 'CmdOrCtrl+Q', role: 'quit', electronOnly: true },
    ],
  },
  {
    id: 'edit',
